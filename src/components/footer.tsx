      ...
      <div className="mx-auto w-full max-w-6xl p-4 sm:p-6 md:p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-6">
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            ...
            {/* НОВАЯ ССЫЛКА НА FAQ В ПОДВАЛЕ */}
            <Link to="/faq" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors py-1 sm:py-0">Частые вопросы (FAQ)</Link>
          </div>
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            ...
            <a href="https://t.me/voltpro_chat" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors py-1 sm:py-0">Чат поддержки (Telegram)</a>
          </div>
        </div>
