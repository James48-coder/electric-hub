        ...
        <div className="w-full overflow-x-auto rounded-xl border border-neutral-800 bg-neutral-900 pb-4 scrollbar-hide">
          <div className="relative min-w-[500px] w-[500px] mx-auto flex flex-col items-center justify-center min-h-[450px]">
            ...
            <div className="flex gap-16 absolute top-16 h-12">
               <div className="w-1 h-full bg-amber-600"></div><div className="w-1 h-full bg-neutral-400"></div><div className="w-1 h-full bg-neutral-600"></div>
            </div>

            <div className="flex justify-between w-[320px] absolute top-28 z-20">
               <div className={`w-28 h-20 border-2 rounded-lg flex flex-col items-center justify-center transition-all duration-300 ${direction === 'forward' ? 'bg-green-900/50 border-green-500 shadow-[0_0_20px_rgba(34,197,94,0.3)]' : 'bg-neutral-950 border-neutral-700'}`}>
               ...
               <div className={`w-28 h-20 border-2 rounded-lg flex flex-col items-center justify-center transition-all duration-300 ${direction === 'reverse' ? 'bg-amber-900/50 border-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.3)]' : 'bg-neutral-950 border-neutral-700'}`}>
                  <span className="font-black text-neutral-300 mb-1">КМ2</span>
                  <div className="flex gap-3">
...
const PanelModule2P = ({ left, top, label, title, isOn, isRelay }: any) => (
  <div className="absolute bg-gradient-to-b from-neutral-100 to-neutral-300 border-2 border-neutral-400 rounded shadow-xl flex flex-col items-center justify-between py-1 z-20" style={{ left, top, width: 60, height: 80 }}>
    <div className="flex justify-between w-full px-2"><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-b border-neutral-600"></div><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-b border-neutral-600"></div></div>
    {isRelay ? (<div className={`w-12 h-7 bg-black rounded flex items-center justify-center border-2 border-neutral-600 ${isOn ? 'text-red-500 shadow-[inset_0_0_8px_rgba(239,68,6,0.8)]' : 'text-neutral-700'}`}><span className="font-mono font-bold text-[11px] tracking-wider">{isOn ? '232' : '000'}</span></div>) : (<div className="flex flex-col items-center mt-1"><div className={`w-4 h-1.5 rounded-sm mb-1 ${isOn ? 'bg-red-500 shadow-[0_0_5px_rgba(239,68,6,0.8)]' : 'bg-green-500'}`}></div><div className="bg-neutral-400 w-8 h-6 rounded flex justify-center items-center shadow-inner border border-neutral-500"><div className={`w-6 h-4 bg-white rounded-sm border-b-4 border-neutral-300 shadow transition-transform ${isOn ? '-translate-y-1' : 'translate-y-1'}`}></div></div></div>)}
    <div className="flex flex-col items-center"><span className="text-[10px] font-black text-neutral-800 leading-none">{label}</span><span className="text-[7px] font-bold text-neutral-600 leading-none mt-0.5">{title}</span></div>
    <div className="flex justify-between w-full px-2"><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-t border-neutral-600"></div><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-t border-neutral-600"></div></div>
  </div>
)
...
const PanelModule1P = ({ left, top, label, isOn }: any) => (
  <div className="absolute bg-gradient-to-b from-neutral-100 to-neutral-300 border-2 border-neutral-400 rounded shadow-xl flex flex-col items-center justify-between py-1 z-20" style={{ left, top, width: 30, height: 80 }}>
    ...
    <div className="flex flex-col items-center mt-1"><div className={`w-3 h-1.5 rounded-sm mb-1 ${isOn ? 'bg-red-500 shadow-[0_0_5px_rgba(239,68,6,0.8)]' : 'bg-green-500'}`}></div><div className="bg-neutral-400 w-5 h-6 rounded flex justify-center items-center shadow-inner border border-neutral-500"><div className={`w-3 h-4 bg-white rounded-sm border-b-4 border-neutral-300 shadow transition-transform ${isOn ? '-translate-y-1' : 'translate-y-1'}`}></div></div></div>
...
const PanelCrossModule = ({ left, top, isOn }: any) => (
  <div className="absolute bg-gradient-to-b from-neutral-100 to-neutral-300 border-2 border-neutral-400 rounded shadow-xl flex flex-col items-center justify-between py-1 z-20" style={{ left, top, width: 60, height: 80 }}>
    <div className="flex justify-between w-full px-2"><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-b border-neutral-600"></div><div className="w-3 h-2 bg-neutral-500 rounded-sm shadow-inner border-b border-neutral-600"></div></div>
    <div className="flex flex-col gap-2 my-auto w-full px-2"><div className={`h-1.5 w-full rounded-sm ${isOn ? 'bg-amber-500 shadow-[0_0_5px_rgba(245,158,11,0.8)]' : 'bg-neutral-400'}`}></div><div className={`h-1.5 w-full rounded-sm ${isOn ? 'bg-blue-500 shadow-[0_0_5px_rgba(59,130,246,0.8)]' : 'bg-neutral-400'}`}></div></div>
